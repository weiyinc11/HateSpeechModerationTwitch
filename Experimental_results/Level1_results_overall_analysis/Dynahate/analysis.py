...
# Load the files
input_file = "Dynahate.csv"
moderated_file = "Dynahate_mod.csv"
non_moderated_file = "Dynahate_notmod.csv"
...
# moderated_df.to_csv('Moderated_Dynahate.csv')
# non_moderated_df.to_csv('Nonmoderated_Dynahate.csv')
...
unmatched_msg_sent_df.to_csv("unmatched_dynahate.csv")
...
TN = len(merged_data[(merged_data['label'] =="nothate") & (merged_data['moderation'] == 0)])
FP = len(merged_data[(merged_data['label'] =="nothate") & (merged_data['moderation'] == 1)])
TP = len(merged_data[(merged_data['label'] =="hate") & (merged_data['moderation'] == 1)])
FN = len(merged_data[(merged_data['label'] =="hate") & (merged_data['moderation'] == 0)])

Dynahate_Global = merged_data[(merged_data['twitch_output'] ==2)]
Dynahate_Global['text'].to_csv("global_dynahate.csv",index=False)
...
merged_data.to_csv('dynahate_Level1.csv', index=False)
