...
# Load the files
input_file = "IHC.csv"
moderated_file = "level1_IHC_nofilterMod.csv"
non_moderated_file = "level1_IHC_nofilterNotMod.csv"
...
merged_data.to_csv('IHC_Level1_nofilter_results.csv', index=False)
