...
# Load the files
input_file = "IHC.csv"
moderated_file = "level1_IHC_morefilterMod.csv"
non_moderated_file = "level1_IHC_morefilterNotMod.csv"
...
merged_data.to_csv('IHC_Level1_morefilter_results.csv', index=False)
