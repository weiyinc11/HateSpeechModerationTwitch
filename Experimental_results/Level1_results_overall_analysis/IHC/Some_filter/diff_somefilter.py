...
# Load the files
input_file = "IHC.csv"
moderated_file = "level1_IHC_somefilterMod.csv"
non_moderated_file = "level1_IHC_somefilterNotMod.csv"
...
merged_data.to_csv('IHC_Level1_somefilter_results.csv', index=False)
