...
# Load the files
input_file = "IHC.csv"
moderated_file = "level1_IHC_lessfilterMod.csv"
non_moderated_file = "level1_IHC_lessfilterNotMod.csv"
...
# Dynahate_Global['text'].to_csv("global_ihc",index=False)
...
merged_data.to_csv('IHC_Level1_lessfilter_results.csv', index=False)
