...
# Load the files
input_file = "Toxigen.csv"
moderated_file = "Toxigen_Mod.csv"
non_moderated_file = "Toxigen_notMod.csv"
...
unmatched_msg_sent_df.to_csv("unmatched_toxigen.csv")
...
Dynahate_Global['text'].to_csv("global_toxigen.csv",index=False)
...
merged_data.to_csv('toxigen_Level1.csv', index=False)
