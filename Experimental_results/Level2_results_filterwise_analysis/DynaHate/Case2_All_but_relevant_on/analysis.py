...
file_groups = [
    {
        ...
        "moderated": "level2C2_disabilityMod.csv",
        "non_moderated": "level2C2_disabilityNotMod.csv"
    },
    {
        "input": "misogyny_hate.csv",
        "moderated": "level2C2_misogynyMod.csv",
        "non_moderated": "level2C2_misogynyNotMod.csv"
    },
    {
        "input": "race_ethnicity_religion_hate.csv",
        "moderated": "level2C2_RERMod.csv",
        "non_moderated": "level2C2_RERNotMod.csv"
    },
    {
        "input": "sexuality_sex_gender_hate.csv",
        "moderated": "level2C2_SSGMod.csv",
        "non_moderated": "level2C2_SSGNotMod.csv"
    }
]

output_csv = "Dynahate_Level2_except1_analysis.csv"
merged_output_dir = "merged_files"
os.makedirs(merged_output_dir, exist_ok=True)
process_multiple_files(file_groups, output_csv, merged_output_dir)
# Example usage
concatenated_output_file = "Dynahate_Level2_except1_results.csv"
