...
file_groups = [
    {
        ...
        "moderated": "level2C1_disabilityMod.csv",
        "non_moderated": "level2C1_disabilityNotMod.csv"
    },
    {
        "input": "misogyny_hate.csv",
        "moderated": "level2C1_misogynyMod.csv",
        "non_moderated": "level2C1_misogynyNotMod.csv"
    },
    {
        "input": "race_ethnicity_religion_hate.csv",
        "moderated": "level2C1_RERMod.csv",
        "non_moderated": "level2C1_RERNotMod.csv"
    },
    {
        "input": "sexuality_sex_gender_hate.csv",
        "moderated": "level2C1_SSGMod.csv",
        "non_moderated": "level2C1_SSGNotMod.csv"
    }
]

output_csv = "Dynahate_Level2_only1_analysis.csv"
merged_output_dir = "merged_files"
os.makedirs(merged_output_dir, exist_ok=True)
process_multiple_files(file_groups, output_csv, merged_output_dir)
# Example usage
concatenated_output_file = "Dynahate_Level2_only1_results.csv"
