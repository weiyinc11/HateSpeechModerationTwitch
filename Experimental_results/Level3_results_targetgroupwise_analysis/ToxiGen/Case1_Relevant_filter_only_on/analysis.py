...
file_groups = [
    {
        ...
        "moderated": "level3C1_maMod.csv",
        "non_moderated": "level3C1_maNotMod.csv"
    },
    {
        "input": "physically_ableism(pa).csv",
        "moderated": "level3C1_paMod.csv",
        "non_moderated": "level3C1_paNotMod.csv"
    },
    {
        "input": "anti_black.csv",
        "moderated": "level3C1_antiblackMod.csv",
        "non_moderated": "level3C1_antiblackNotMod.csv"
    },
    {
        "input": "anti_semitism.csv",
        "moderated": "level3C1_antisemitismMod.csv",
        "non_moderated": "level3C1_antisemitismNotMod.csv"
    },
    {
        "input": "Islamophobia.csv",
        "moderated": "level3C1_islamophobiaMod.csv",
        "non_moderated": "level3C1_islamophobiaNotMod.csv"
    },
]

output_csv = "Toxigen_Level3_only1_analysis.csv"
merged_output_dir = "merged_files"
os.makedirs(merged_output_dir, exist_ok=True)
process_multiple_files(file_groups, output_csv, merged_output_dir)
# Example usage
concatenated_output_file = "Toxigen_Level3_only1_results.csv"
