...
def analyze_file(input_file, moderated_file, non_moderated_file):
    ...
    input_df['label'] = np.where(
    (input_df['roberta_prediction'] <= 0.2) & (input_df['prompt_label'] == 0), 0,
    np.where((input_df['roberta_prediction'] >= 0.8) & (input_df['prompt_label'] == 1), 1, None))
...
file_groups = [
    {
        "input": "mentally_ableism(ma).csv",
        "moderated": "level3C3_maMod.csv",
        "non_moderated": "level3C3_maNotMod.csv"
    },
    {
        "input": "physically_ableism(pa).csv",
        "moderated": "level3C3_paMod.csv",
        "non_moderated": "level3C3_paNotMod.csv"
    },
    {
        "input": "anti_black.csv",
        "moderated": "level3C3_antiblackMod.csv",
        "non_moderated": "level3C3_antiblackNotMod.csv"
    },
    {
        "input": "anti_semitism.csv",
        "moderated": "level3C3_antisemitismMod.csv",
        "non_moderated": "level3C3_antisemitismNotMod.csv"
    },
    {
        "input": "Islamophobia.csv",
        "moderated": "level3C3_islamophobiaMod.csv",
        "non_moderated": "level3C3_islamophobiaNotMod.csv"
    },
]

output_csv = "Toxigen_Level3_allfilters_analysis.csv"
merged_output_dir = "merged_files"
os.makedirs(merged_output_dir, exist_ok=True)
process_multiple_files(file_groups, output_csv, merged_output_dir)
# Example usage
concatenated_output_file = "Toxigen_Level3_allfilters_results.csv"
