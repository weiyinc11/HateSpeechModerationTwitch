...
file_groups = [
    ...
    {
        "input": "Misandry.csv",
        "moderated": "level3C1_misandryMod.csv",
        "non_moderated": "level3C1_misandryNotMod.csv"
    }
]

output_csv = "Dynahate_Level3_only1_analysis.csv"
merged_output_dir = "merged_files"
os.makedirs(merged_output_dir, exist_ok=True)
process_multiple_files(file_groups, output_csv, merged_output_dir)
# Example usage
concatenated_output_file = "Dynahate_Level3_only1_results.csv"
