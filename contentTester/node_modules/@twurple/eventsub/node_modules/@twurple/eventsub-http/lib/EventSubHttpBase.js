...
class EventSubHttpBase extends eventsub_base_1.EventSubBase {
    constructor(config) {
        ...
        if (config.apiClient._authProvider.tokenType !== 'app') {
            throw new auth_1.InvalidTokenTypeError('EventSub over HTTP requires app access tokens to work; please use the ClientCredentialsAuthProvider in your API client.');
        }
